/*
    ...
    Banderas:
        ...
        g: global. Busca de forma global, es decir, no se detiene después de la primera coincidencia
    ...
    Cantidad:
        - llaves: lo que está antes tiene que aparecer la cantidad exacta de veces. Hay tres combinaciones posibles. 
            ...
            {n,m} Se tiene que repetir entre n(minimo) y m(maximo) veces, ambas incluidas.
...
const regEx = /lorem/gi //devuelve true o false
